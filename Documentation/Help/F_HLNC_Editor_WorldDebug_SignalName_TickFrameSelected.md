...
<file name="F_HLNC_Editor_WorldDebug_SignalName_TickFrameSelected" /># TickFrameSelected Field<span id="PageHeader"> </span>


\[Missing &lt;summary&gt; documentation for "F:HLNC.Editor.WorldDebug.SignalName.TickFrameSelected"\]
...
**C#**
``` C#
<span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">readonly</span> <span class="identifier">StringName</span> <span class="identifier">TickFrameSelected</span>
```
