...
<file name="F_Nebula_Serialization_Serializers_NetPropertiesSerializer_MethodName_Lerp" /># Lerp Field<span id="PageHeader"> </span>


Cached name for the 'Lerp' method.
...
**C#**
``` C#
<span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">readonly</span> <span class="identifier">StringName</span> <span class="identifier">Lerp</span>
```
