...
<file name="F_HLNC_NetworkRunner_MethodName_TransferInput" /># TransferInput Field<span id="PageHeader"> </span>


Cached name for the 'TransferInput' method.
...
**C#**
``` C#
<span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">readonly</span> <span class="identifier">StringName</span> <span class="identifier">TransferInput</span>
```
