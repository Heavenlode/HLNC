...
<file name="F_HLNC_Editor_WorldDebug_PropertyName_IsLive" /># IsLive Field<span id="PageHeader"> </span>


\[Missing &lt;summary&gt; documentation for "F:HLNC.Editor.WorldDebug.PropertyName.IsLive"\]
...
**C#**
``` C#
<span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">readonly</span> <span class="identifier">StringName</span> <span class="identifier">IsLive</span>
```
