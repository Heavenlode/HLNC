...
<file name="F_HLNC_WorldRunner_MethodName_ReceiveInput" /># ReceiveInput Field<span id="PageHeader"> </span>


\[Missing &lt;summary&gt; documentation for "F:HLNC.WorldRunner.MethodName.ReceiveInput"\]
...
**C#**
``` C#
<span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">readonly</span> <span class="identifier">StringName</span> <span class="identifier">ReceiveInput</span>
```
