...
<file name="F_HLNC_Editor_WorldDebug_SignalName_TickFrameReceived" /># TickFrameReceived Field<span id="PageHeader"> </span>


\[Missing &lt;summary&gt; documentation for "F:HLNC.Editor.WorldDebug.SignalName.TickFrameReceived"\]
...
**C#**
``` C#
<span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">readonly</span> <span class="identifier">StringName</span> <span class="identifier">TickFrameReceived</span>
```
