# WorldRunner.OnPeerSyncStatusChangeEventHandler Delegate


\[Missing &lt;summary&gt; documentation for "T:HLNC.WorldRunner.OnPeerSyncStatusChangeEventHandler"\]
...
**C#**
``` C#
public delegate void OnPeerSyncStatusChangeEventHandler(
	string peerId,
	int status
)
```
