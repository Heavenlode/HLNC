...
<file name="F_HLNC_Downloader_PropertyName_currentTargetDir" /># currentTargetDir Field<span id="PageHeader"> </span>


\[Missing &lt;summary&gt; documentation for "F:HLNC.Downloader.PropertyName.currentTargetDir"\]
...
**C#**
``` C#
<span class="keyword">public</span> <span class="keyword">static</span> <span class="keyword">readonly</span> <span class="identifier">StringName</span> <span class="identifier">currentTargetDir</span>
```
