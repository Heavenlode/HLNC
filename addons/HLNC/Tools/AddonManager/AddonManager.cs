...
namespace HLNC.Internal.Editor {
    ...
    public partial class AddonManager : Window
    {
        ...
        private const string REPO_LIST_URL = "https://raw.githubusercontent.com/Heavenlode/HLNC.Addons/refs/heads/main/repo-list.json";
        ...
        private void _OnInstall()
        {
            ...
            string addonsDir = ProjectSettings.GlobalizePath("res://addons/HLNCAddons");
