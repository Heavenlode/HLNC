...
var bar_red_stylebox = preload("res://addons/Nebula/Tools/Debugger/Ticks/tick_frame_bar_color_red.tres")
var bar_yellow_stylebox = preload("res://addons/Nebula/Tools/Debugger/Ticks/tick_frame_bar_color_yellow.tres")
var bar_green_stylebox = preload("res://addons/Nebula/Tools/Debugger/Ticks/tick_frame_bar_color_green.tres")

var unselected_outline = preload("res://addons/Nebula/Tools/Debugger/Ticks/tick_frame_unselected.tres")
var selected_outline = preload("res://addons/Nebula/Tools/Debugger/Ticks/tick_frame_selected.tres")
